...
import { setDoc, doc, serverTimestamp, getDoc, collection, getDocs, addDoc, updateDoc , deleteDoc} from "firebase/firestore";
...
export const checkRoutineInFirebase = async (uid, routineId) => {
    try {
        await updateDoc(doc(db, `/users/${uid}/routines`, routineId), {
            isSubmitted: true,
        })
