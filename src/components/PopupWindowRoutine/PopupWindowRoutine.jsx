...
const PopupWindowRoutine = ({ user, addRoutine, setPopup, routines }) => {
    ...
    return (
        <div className="add-routine-window" >
            ...
            {
                showTimePiker && <div className="add-routine-window__clock">
                    <TimeKeeper
            ...
            <Zoom duration={500}>
                <form className="add-routine-window__popup" onSubmit={handleSubmit}>
                    ...
                    <input type="text" className="add-routine-window__title-input" name="title" id="routine-title"
                        value={addRoutineForm.title}
                        onChange={handleChange} />
                    <h4 className='add-routine-window__description-input-label'>Description</h4>
                    <textarea className='add-routine-window__description-input' name="description" id="routine-description" cols="30" rows="10"
                        value={addRoutineForm.description}
                        onChange={handleChange}></textarea>
                    <h4 className='add-routine-window__message-input-label'>Message</h4>
                    <textarea className='add-routine-window__message-input' name="message" id="routine-message" cols="30" rows="10"
